...
XDA_DLL_API int XsSyncSetting_isInput(const struct XsSyncSetting* thisPtr);
XDA_DLL_API int XsSyncSetting_isOutput(const struct XsSyncSetting* thisPtr);
XDA_DLL_API void XsSyncSetting_swap(struct XsSyncSetting* a, struct XsSyncSetting* b);
...
struct XsSyncSetting {
	...
	XsSyncFunction	m_function;					/*!< The action to be performed, when an input sync line changes \see XsSyncInAction. */
	...
	XsSyncSetting(XsSyncLine line = XSL_Invalid
